...
import com.enterprise.android.canadainfo.R;
...
public class RefreshableListView extends ListView {
    ...
    private void initialize() {
        ...
        mHeaderContainer = inflater.inflate(R.layout.activity_refershable_view, null);
    ...
    private void setHeaderHeight(final int height) {
        ...
        if (!mIsRefreshing) {
            ...
            if (height > mHeaderHeight && !mArrowUp) {
                mArrow.startAnimation(AnimationUtils.loadAnimation(getContext(), R.animator.refersh_animation));
    ...
    private void startRefreshing() {
        ...
        mText.setText("Updating content...");
        mIsRefreshing = true;
